...
def get_response(messages , model):
    ...
    resp = requests.get(" https://8350-2a09-bac5-3aff-101e-00-19b-198.ap.ngrok.io/query", params={"search": messages})
    print(resp.text)
    return {"role":"assistant", "content":resp.json()["response"]["text"]}
